...
namespace CrudTesteTecnico2019.Database.Migrations
{
    ...
    [Migration("20190710200125_InitialCreate")]
                    ...
                    b.OwnsOne("CrudTesteTecnico2019.Domain.Usuario.ObjectValue.DataNascimento", "DataNascimento", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    Value = new DateTime(2019, 7, 10, 17, 1, 22, 207, DateTimeKind.Local).AddTicks(3512)
                                },
                                new
                                {
                                    UsuarioDomainUsuarioId = 2L,
                                    Value = new DateTime(1990, 7, 10, 17, 1, 22, 211, DateTimeKind.Local).AddTicks(8774)
                                },
                                new
                                {
                                    UsuarioDomainUsuarioId = 3L,
                                    Value = new DateTime(1992, 7, 10, 17, 1, 22, 211, DateTimeKind.Local).AddTicks(9164)
                                },
                                new
                                {
                                    UsuarioDomainUsuarioId = 4L,
                                    Value = new DateTime(1992, 7, 10, 17, 1, 22, 211, DateTimeKind.Local).AddTicks(9462)
                                });
                        });
